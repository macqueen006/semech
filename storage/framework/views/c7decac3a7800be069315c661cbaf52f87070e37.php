                    ...
                    <div class="footer-widget text-var--2">
                        <div class="logo">
                            <a href="<?php echo e(url('/')); ?>">
                                <img src="<?php echo e(asset('img/logo/semech-systems-logo-1.png')); ?>" alt="semech white">
                            </a>
                        </div>
                        ...
                        <div class="ft-instagram-list">
                            ...
                            <div class="instagram-grid-wrap">
                                ...
                                <div class="item-grid grid-style--1">
                                    <div class="thumb">
                                        <a href="#">
                                            <img src="<?php echo e(asset('img/instagram/instagram-1/instagram-7.jpg')); ?>" alt="images">
                                        </a>
                                        <div class="item-info">
                                            <div class="inner">
                                ...
                                <div class="item-grid grid-style--1">
                                    <div class="thumb">
                                        <a href="#">
                                            <img src="<?php echo e(asset('img/instagram/instagram-1/instagram-8.jpg')); ?>" alt="images">
                                        </a>
                                        <div class="item-info">
                                            <div class="inner">
                                                <a href="#"><i class="fas fa-heart"></i>1k</a>
                                ...
                                <div class="item-grid grid-style--1">
                                    <div class="thumb">
                                        <a href="#">
                                            <img src="<?php echo e(asset('img/instagram/instagram-1/instagram-9.jpg')); ?>" alt="images">
                                        </a>
                                        <div class="item-info">
                                            <div class="inner">
                                                <a href="#"><i class="fas fa-heart"></i>1k</a>
                                ...
                                <div class="item-grid grid-style--1">
                                    <div class="thumb">
                                        <a href="#">
                                            <img src="<?php echo e(asset('img/instagram/instagram-1/instagram-10.jpg')); ?>" alt="images">
                                        </a>
                                        <div class="item-info">
                                            <div class="inner">
                                                <a href="#"><i class="fas fa-heart"></i>1k</a>
                                ...
                                <div class="item-grid grid-style--1">
                                    <div class="thumb">
                                        <a href="#">
                                            <img src="<?php echo e(asset('img/instagram/instagram-1/instagram-11.jpg')); ?>" alt="images">
                                        </a>
                                        <div class="item-info">
                                            <div class="inner">
                                                <a href="#"><i class="fas fa-heart"></i>1k</a>
                                ...
                                <div class="item-grid grid-style--1">
                                    <div class="thumb">
                                        <a href="#">
                                            <img src="<?php echo e(asset('img/instagram/instagram-1/instagram-12.jpg')); ?>" alt="images">
                                        </a>
                                        <div class="item-info">
                                            <div class="inner">
                                                <a href="#"><i class="fas fa-heart"></i>1k</a>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="copyright-left text-md-start text-center">
                        <ul class="bk-copyright-menu d-flex bk-hover justify-content-center justify-content-md-start flex-wrap flex-sm-nowrap">
                            <li><a href="<?php echo e(route('blog.index')); ?>">Our blog</a></li>
                            <li><a href="<?php echo e(route('service')); ?>">Latest projects</a></li>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="copyright-right text-md-end text-center">
                        <p>© 2022 Semech. <b>All Rights Reserved.</b> </p>
                    </div>
                </div>
            </div>
        </div>
...
<!--// Footer -->
<?php /**PATH C:\xampp\htdocs\freeze\breeze\resources\views/components/partials/footer.blade.php ENDPATH**/ ?>