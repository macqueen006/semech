...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group mb_20">
                                ...
                                <textarea id="open-source-plugins" name="body"><?php echo e(old('body')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group mb_20">
                            ...
                            <input type="text" id="datepicker" name="published_at"
                                   value="<?php echo e(old('published_at')); ?>" placeholder="YYYY MM DD" autocomplete="off">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group mb_20">
                            ...
                            <input type="text" class="form-control mb-2" name="photo_credit_text"
                                   ...
                                   value="<?php echo e(old('photo_credit_text')); ?>" autocomplete="off">
                        </div>
