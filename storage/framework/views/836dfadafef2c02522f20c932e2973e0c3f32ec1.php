<!-- Start Team Caption -->
<div class="bk-team-with-caption-area ptb--120 ptb-md--80 ptb-sm--60 bg_color--1 poss_relative">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="brook-section-title text-center mb--70">
                    <h3 class="heading heading-h3 line-height-1-25">Brook architects</h3>
                </div>
            </div>
        </div>
        <div class="row row--30">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                <div class="team team__style--3">
                    <div class="thumb">
                        <img src="<?php echo e(asset('img/architecture/team1.jpg')); ?>" alt="team Images">
                        <div class="overlay" style="background-image: url(<?php echo e(asset('img/architecture/team1.jpg')); ?>);"></div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-12 mt_mobile--40">
                <div class="team team__style--3 move-up wow" data-wow-delay=".13s">
                    <div class="thumb">
                        <img src="<?php echo e(asset('img/architecture/team2.jpg')); ?>" alt="Images">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-12 mt_sm--40">
                <div class="team team__style--3 move-up wow" data-wow-delay="0.16s">
                    <div class="thumb">
                        <img src="<?php echo e(asset('img/architecture/team3.jpg')); ?>" alt="Images">
...
<!-- End Team Caption -->
<?php /**PATH C:\xampp\htdocs\freeze\breeze\resources\views/components/layouts/team.blade.php ENDPATH**/ ?>