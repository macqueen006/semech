...
<?php $component->withAttributes([]); ?>
         <?php $__env->slot('image', null, []); ?> 
            <?php echo e(asset('img/semech/gdtography-911738.jpg')); ?>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12">
                        <div class="about-thumb text-center text-lg-end pr--100 pr_md--15 pr_sm--15">
                            <img src="<?php echo e(asset('img/architecture/about2.png')); ?>" alt="image">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12">
            ...
            <div class="row row--0 align-items-center">
                <div class="col-lg-12 col-xl-6">
                    <div class="bext-service thumb">
                        <img src="<?php echo e(asset('img/architecture/perfection.jpg')); ?>" alt="images">
                    </div>
                </div>
                <div class="col-lg-12 col-xl-6">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 col-12 pl--100 plr_lg--10 plr_md--50 plr_sm--50 mt_md--40 mt_sm--40">
                        <div class="thumb">
                            <img src="<?php echo e(asset('img/architecture/skills.jpg')); ?>" alt="image">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="thumb text-lg-left text-center pr--60 pr_md--5 pr_sm--5">
                            <img src="<?php echo e(asset('img/architecture/challenge.jpg')); ?>" alt="images">
                        </div>
                    </div>
                        ...
                        <div class="bk-accordion-style--2" id="accordionExampl3">
                            ...
                            <div class="card">
                                <div class="card-header" id="headingsix">
                                    <h5 class="mb-0">
                                        <a href="<?php echo e(route('about')); ?>" class="acc-btn" data-bs-toggle="collapse" data-bs-target="#collapsesix"
                            ...
                            <div class="card">
                                <div class="card-header" id="headingseven">
                                    <h5 class="mb-0">
                                        <a href="<?php echo e(route('about')); ?>" class="acc-btn collapsed" data-bs-toggle="collapse" data-bs-target="#collapseseven"
                            ...
                            <div class="card">
                                <div class="card-header" id="headingeight">
                                    <h5 class="mb-0">
                                        <a href="<?php echo e(route('about')); ?>" class="acc-btn collapsed" data-bs-toggle="collapse" data-bs-target="#collapeight"
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\freeze\breeze\resources\views/pages/about/index.blade.php ENDPATH**/ ?>