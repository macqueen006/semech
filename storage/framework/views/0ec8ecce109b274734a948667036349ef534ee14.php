...
<div id="comment-<?php echo e($comment->getKey()); ?>" class="media">
    <img class="mr-3 rounded-circle" src="https://www.gravatar.com/avatar/<?php echo e(md5($comment->commenter->email ?? $comment->guest_email)); ?>.jpg?s=64" alt="<?php echo e($comment->commenter->name ?? $comment->guest_name); ?> Avatar">
    <div class="media-body">
        ...
        <div>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('reply-to-comment', $comment)): ?>
                <button data-bs-toggle="modal" data-bs-target="#reply-modal-<?php echo e($comment->getKey()); ?>" class="btn btn-sm btn-link text-uppercase"><?php echo app('translator')->get('comments::comments.reply'); ?></button>
            <?php endif; ?>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit-comment', $comment)): ?>
                <button data-bs-toggle="modal" data-bs-target="#comment-modal-<?php echo e($comment->getKey()); ?>" class="btn btn-sm btn-link text-uppercase"><?php echo app('translator')->get('comments::comments.edit'); ?></button>
            <?php endif; ?>
...
<?php if($grouped_comments->has($comment->getKey()) && $indentationLevel > $maxIndentationLevel): ?>
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\freeze\breeze\resources\views/vendor/comments/_comment.blade.php ENDPATH**/ ?>