...
<nav class="sidebar">
    <div class="logo d-flex justify-content-between">
        <a href="{{ route('admin.index') }}"><img src="{{ asset('admins/img/logo.png') }}" alt="image"></a>
    ...
    <ul id="sidebar_menu">
        ...
        <li class="">
            <a   class="has-arrow" href="#" aria-expanded="false">
                <img src="{{ asset('admins/img/menu-icon/4.svg') }}" alt="images">
        ...
        <li class="">
            <a   class="has-arrow" href="#" aria-expanded="false">
                <img src="{{ asset('admins/img/menu-icon/5.svg') }}" alt="images">
                <span>Widgets</span>
            </a>
            <ul>
        ...
        <li class="">
            <a   class="has-arrow" href="#" aria-expanded="false">
                <img src="{{ asset('admins/img/menu-icon/6.svg') }}" alt="images">
                <span>Forms</span>
            </a>
            <ul>
                <li><a href="#">Elements</a>
        ...
        <li class="">
            <a   class="has-arrow" href="#" aria-expanded="false">
                <img src="{{ asset('admins/img/menu-icon/7.svg') }}" alt="images">
                <span>Charts</span>
            </a>
            <ul>
