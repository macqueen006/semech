...
<!-- swiper slider CSS -->
<link rel="stylesheet" href="{{ asset('admins/vendors/swiper_slider/css/swiper.min.css') }}" />
<!-- select2 CSS -->
<link rel="stylesheet" href="{{ asset('admins/vendors/select2/css/select2.min.css') }}" />
<!-- select2 CSS -->
