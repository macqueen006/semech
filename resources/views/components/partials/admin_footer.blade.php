...
<!-- jquery slim -->
<script src="{{ asset('admins/js/jquery-3.4.1.min.js') }}"></script>
<!-- popper js -->
...
<!-- swiper slider js -->
<script src="{{ asset('admins/vendors/swiper_slider/js/swiper.min.js') }}"></script>
<!-- nice select -->
...
<!-- gijgo css -->
<script src="{{ asset('admins/vendors/gijgo/gijgo.min.js') }}"></script>
